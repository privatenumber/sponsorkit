...
declare function genSvgImage(x: number, y: number, size: number, base64image: string, radius: number): string;
declare function generateBadge(x: number, y: number, sponsor: Sponsor, preset: BadgePreset, radius: number): string;
...
type OutputFormat = 'svg' | 'png' | 'webp' | 'json';
...
declare const dataWebpBase64 = "data:image/webp;base64,";
...
declare function convertToWebp(image: Buffer$1, size: number): Promise<Buffer$1>;
...
export { type BadgePreset, type CircleRenderOptions, FALLBACK_AVATAR, type GitHubAccountType, GitHubProvider, type OutputFormat, type Provider, type ProviderName, type ProvidersConfig, ProvidersMap, type Sponsor, type SponsorMatcher, type SponsorkitConfig, type SponsorkitMainConfig, type SponsorkitRenderOptions, type SponsorkitRenderer, type Sponsorship, SvgComposer, type Tier, type TierPartition, convertToWebp, dataWebpBase64, defaultConfig, defaultInlineCSS, defaultTiers, defineConfig, fetchGitHubSponsors, fetchSponsors, genSvgImage, generateBadge, guessProviders, loadConfig, makeQuery, partitionTiers, presets, resolveAvatars, resolveProviders, tierPresets };
