...
declare function round(image: string | ArrayBuffer, radius?: number, size?: number): Promise<Buffer$1>;
declare function svgToPng(svg: string): Promise<Buffer$1>;
declare function pngToDataUri(png: Buffer$1): string;
...
export { type BadgePreset, type CircleRenderOptions, FALLBACK_AVATAR, type GitHubAccountType, GitHubProvider, type OutputFormat, type Provider, type ProviderName, type ProvidersConfig, ProvidersMap, type Sponsor, type SponsorMatcher, type SponsorkitConfig, type SponsorkitMainConfig, type SponsorkitRenderOptions, type SponsorkitRenderer, type Sponsorship, SvgComposer, type Tier, type TierPartition, arrayBufferToBase64, base64ToArrayBuffer, defaultConfig, defaultInlineCSS, defaultTiers, defineConfig, fetchGitHubSponsors, fetchSponsors, genSvgImage, generateBadge, guessProviders, loadConfig, makeQuery, partitionTiers, pngToDataUri, presets, resolveAvatars, resolveProviders, round, svgToPng, tierPresets };
