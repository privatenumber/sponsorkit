...
async function resolveAvatars(ships, getFallbackAvatar, t = consola) {
  ...
  return Promise.all(ships.map((ship) => limit(async () => {
    const data = ship.privacyLevel === "PRIVATE" || !ship.sponsor.avatarUrl ? fallbackAvatar : await $fetch(ship.sponsor.avatarUrl, {
...
export { FALLBACK_AVATAR as F, GitHubProvider as G, ProvidersMap as P, SvgComposer as S, partitionTiers as a, base64ToArrayBuffer as b, resolveProviders as c, guessProviders as d, resolveAvatars as e, defineConfig as f, generateBadge as g, defaultTiers as h, defaultInlineCSS as i, defaultConfig as j, presets as k, loadConfig as l, arrayBufferToBase64 as m, genSvgImage as n, fetchSponsors as o, pngToDataUri as p, fetchGitHubSponsors as q, round as r, svgToPng as s, tierPresets as t, makeQuery as u, version as v };
