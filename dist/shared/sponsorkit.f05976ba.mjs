...
`;
const FALLBACK_AVATAR = rasterizeSvg(fallback, "webp");
...
const dataWebpBase64 = "data:image/webp;base64,";
async function resolveAvatars(ships, getFallbackAvatar, t = consola) {
  ...
  return Promise.all(ships.map((ship) => limit(async () => {
    const pngArrayBuffer = ship.privacyLevel === "PRIVATE" || !ship.sponsor.avatarUrl ? fallbackAvatar : await $fetch(ship.sponsor.avatarUrl, {
...
async function convertToWebp(image, size) {
...
export { FALLBACK_AVATAR as F, GitHubProvider as G, ProvidersMap as P, SvgComposer as S, guessProviders as a, resolveAvatars as b, convertToWebp as c, rasterizeSvg as d, defineConfig as e, defaultTiers as f, generateBadge as g, defaultInlineCSS as h, defaultConfig as i, presets as j, dataWebpBase64 as k, loadConfig as l, genSvgImage as m, fetchSponsors as n, fetchGitHubSponsors as o, partitionTiers as p, makeQuery as q, resolveProviders as r, tierPresets as t, version as v };
